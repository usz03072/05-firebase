...
public class MemoList2Activity extends AppCompatActivity {
    private static final int REQUEST_CREATE = 0;
    private static final int REQUEST_EDIT = 1;
    MemoRecyclerView2Adapter MemoRecyclerView2Adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_memo_list2);
        MemoRecyclerView2Adapter = new MemoRecyclerView2Adapter(this,
    ...
    @Override public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_create) {
            ...
            builder.setPositiveButton(R.string.yes,
                    (dialog, index) -> MemoRecyclerView2Adapter.removeCheckedMemo());
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            if (requestCode == REQUEST_CREATE)
                MemoRecyclerView2Adapter.add(memo);
            else if (requestCode == REQUEST_EDIT)
                MemoRecyclerView2Adapter.update(memo);
        }
    }
